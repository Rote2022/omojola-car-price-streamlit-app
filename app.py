...
st.title("Nilay's Used Car Price Prediction App")
...
price = st.number_input("Enter original price (R)", min_value=10000, max_value=10000000, value=None)
...
if st.button("Predict Price"):
    data = np.array([price, km, age, fuel[0], fuel[1], fuel[2], trans[0], trans[1]])
